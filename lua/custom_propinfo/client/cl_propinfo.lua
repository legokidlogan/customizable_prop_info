...
local CPI_BACKGROUND_VALUE = createClientConVarCPI( "background_value", 120, true, false, "The brightness of the CPI display background.", 0, 255 )
local CPI_BACKGROUND_ALPHA = createClientConVarCPI( "background_alpha", 50, true, false, "The opacity of the CPI display background.", 0, 255 )
...
local CPI_FONT_SIZE = createClientConVarCPI( "font_size", 20, true, false, "Font size for the CPI display, in pixels. Determines overall display size.", 8, 50 )
